...
BIRD_IMGS = [p.transform.scale2x(p.image.load("bird1.png")),
             p.transform.scale2x(p.image.load("bird2.png")),
             p.transform.scale2x(p.image.load("bird3.png"))]

BG_IMG = p.transform.scale(p.image.load("bg.png"), (600, 900))
PIPE_IMG = p.transform.scale2x(p.image.load("pipe.png"))
BASE_IMG = p.transform.scale2x(p.image.load("base.png"))
...
if __name__ == "__main__":
    ...
    config_path = os.path.join(local_dir, "Flappy_bird_NEAT.txt")
    running(config_path)
